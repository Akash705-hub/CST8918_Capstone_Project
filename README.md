...
| **Akash Patel** | Terraform AKS module, create AKS clusters for Test and Production environments, validate Kubernetes connectivity | ⏳ Pending |
| **Divyang Lodariya** | Terraform ACR module, Terraform Redis module, configure Azure Container Registry and Azure Cache for Redis for Test and Production | ⏳ Pending |
...
```bash
git clone https://github.com/rodr0304/CST8918.git
cd CST8918/FinalProject-Group3
```
